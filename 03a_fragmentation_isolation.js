...
Map.addLayer(lulc.select('classification_2023'), vis, 'lulc', false); // Adiciona a camada de biomas ao mapa
var lulc_pant = lulc.mask(pantanal)
Map.addLayer(lulc_pant.select('classification_2023'), vis, 'lulc_pant', false); // Adiciona a camada de biomas ao mapa
...
//        var forestMask85a23_100m = forestMask_ano;
        var naturalMask85a23_100m = naturalMask_ano.blend(nonforestPant_ano);
    } else {
//        forestMask85a23_100m = forestMask85a23_100m.addBands(forestMask_ano);
        naturalMask85a23_100m = naturalMask85a23_100m.addBands(naturalMask_ano.blend(nonforestPant_ano));
    }
}

Map.addLayer(naturalMask85a23_100m.select('natural_2023'), vis, 'naturalMask85a23_100m', false); // Adiciona a camada de biomas ao mapa


// Exibe as máscaras combinadas no console
//print('forestMask85a23_100m', forestMask85a23_100m);
print('naturalMask85a23_100m', naturalMask85a23_100m);
...
Export.image.toAsset({
    "image": naturalMask85a23_100m.toInt16(),
    "description": 'natural_Mask85a23_100m_v' + v_out,
    "assetId": dirout + 'natural_Mask85a23_100m_v' + v_out,
    "scale": 100,
    "pyramidingPolicy": {'.default': 'mode'},
    "maxPixels": 1e13,
    "region": geometry
